...
void display3D()
{
	...
	glutSolidTeapot(8.0); // replace this with your code to create and draw the surface of revolution
...
void buildVertexArray()
{
	...
	printf("%d ", subcurve.numControlPoints);
	printf("%d ", subcurve.subdivisionSteps);
	printf("%d\n", subcurve.numCurvePoints);
}
